    ...
    <div className="bg-gray-800 p-4 rounded-xl border border-gray-700">
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        <div className="bg-green-900/30 p-2 rounded border border-green-700/50">
          ...
          <div className="text-lg font-bold text-green-300">{statusStats.present}</div>
        </div>
        <div className="bg-red-900/30 p-2 rounded border border-red-700/50">
          ...
          <div className="text-lg font-bold text-red-300">{statusStats.absent}</div>
        </div>
        <div className="bg-yellow-900/30 p-2 rounded border border-yellow-700/50">
          ...
          <div className="text-lg font-bold text-yellow-300">{statusStats.late}</div>
        </div>
      </div>
      ...
      <div className="mt-3 pt-3 border-t border-gray-700">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="flex items-center gap-1">
            <div className="w-3 h-3 bg-green-900/30 border border-green-700/50 rounded"></div>
            <span className="text-xs text-gray-400">Present</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-3 h-3 bg-yellow-900/30 border border-yellow-700/50 rounded"></div>
            <span className="text-xs text-gray-400">Late</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-3 h-3 bg-red-900/30 border border-red-700/50 rounded"></div>
