...
import { DollarSign, Clock, AlertTriangle, Calendar, CheckCircle, Zap, TrendingUp, History } from 'lucide-react';
            ...
            {/* Stats Grid */}
                ...
                <div className="group relative bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
                    ...
                    <div className="relative">
                        ...
                        <p className="text-3xl font-extrabold text-white">{Web3.utils.fromWei(monthlyWage, 'ether')}</p>
