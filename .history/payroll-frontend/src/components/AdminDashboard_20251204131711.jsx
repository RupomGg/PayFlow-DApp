...
function AdminDashboard({ contract, account }) {
    ...
    const previewEmployeeSalary = async (address) => {
        ...
        try {
            const empData = await contract.methods.employees(address).call();
            ...
            setPreviewUnpaidAmount(Web3.utils.fromWei(empData.currentUnpaidAmount, 'ether'));
        } catch (err) {
    ...
    const searchEmployee = async () => {
        ...
        try {
            ...
            if (userData.walletAddress === '0x0000000000000000000000000000000000000000') {
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-white rounded-xl p-4 space-y-2">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-sm font-bold text-purple-600">{searchedEmployee.role}</span>
                                    </div>
                                    <div className="flex justify-between">
