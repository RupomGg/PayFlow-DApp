...
function AdminDashboard({ contract, account }) {
    ...
    const loadStats = React.useCallback(async () => {
        try {
            ...
            for (const empAddr of allEmps) {
                ...
                if (userData.role === '1') { // Role.Manager = 1
                    managers++;
                }
            }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50/30 py-6 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto space-y-6">
            {/* Compact Header with Stats */}
            <div className="relative overflow-hidden bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-700 rounded-2xl p-6 shadow-xl shadow-emerald-500/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border-2 border-blue-200 shadow-md">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <RefreshCw className="h-4 w-4 text-blue-600 cursor-pointer hover:animate-spin" onClick={loadContractBalance} />
                    </div>
                    <p className="text-xs font-medium text-gray-600">Balance</p>
                    <p className="text-2xl font-bold text-blue-600 mt-1">{contractBalance}</p>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border-2 border-purple-200 shadow-md">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <RefreshCw className="h-4 w-4 text-purple-600 cursor-pointer hover:animate-spin" onClick={loadStats} />
                    </div>
                    <p className="text-xs font-medium text-gray-600">Employees</p>
                    <p className="text-2xl font-bold text-purple-600 mt-1">{totalEmployees}</p>
                    <p className="text-xs text-gray-500 mt-1">Total</p>
                </div>

                {/* Total Managers */}
                <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-4 border-2 border-amber-200 shadow-md">
                    <div className="flex items-center justify-between mb-2">
                        <div className="bg-amber-500 p-2 rounded-lg">
                            <Award className="h-5 w-5 text-white" />
                        </div>
                        <RefreshCw className="h-4 w-4 text-amber-600 cursor-pointer hover:animate-spin" onClick={loadStats} />
                    </div>
                    <p className="text-xs font-medium text-gray-600">Managers</p>
                    <p className="text-2xl font-bold text-amber-600 mt-1">{totalManagers}</p>
                    <p className="text-xs text-gray-500 mt-1">Total</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 border-2 border-orange-200 shadow-md">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <RefreshCw className="h-4 w-4 text-orange-600 cursor-pointer hover:animate-spin" onClick={loadPendingRequests} />
                    </div>
                    <p className="text-xs font-medium text-gray-600">Pending Requests</p>
                    <p className="text-2xl font-bold text-orange-600 mt-1">{pendingRequests.length}</p>
