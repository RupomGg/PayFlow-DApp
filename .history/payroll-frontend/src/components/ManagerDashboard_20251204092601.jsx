...
import { UserPlus, Clock, Users, RefreshCw, Award, TrendingUp } from 'lucide-react';
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-700 rounded-3xl p-8 shadow-2xl shadow-emerald-500/20">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-teal-50 text-lg font-medium">Build and manage your team with ease</p>
                </div>
            </div>
                ...
                {/* Assign Shift */}
                    ...
                    <div className="relative p-7">
                        ...
                        <div className="space-y-4">
                            <input value={shiftEmp} className="w-full bg-gray-50 border-2 border-gray-200 p-4 rounded-xl focus:ring-2 focus:ring-blue-400 focus:border-blue-400 outline-none transition-all font-mono text-sm placeholder:text-gray-400 hover:border-gray-300" placeholder="Employee Address (0x...)" onChange={e => setShiftEmp(e.target.value)} />
                            <select value={shiftTime} className="w-full bg-gray-50 border-2 border-gray-200 p-4 rounded-xl focus:ring-2 focus:ring-blue-400 focus:border-blue-400 outline-none transition-all appearance-none hover:border-gray-300 cursor-pointer" onChange={e => setShiftTime(e.target.value)}>
                            ...
                            <button onClick={assignShift} className="w-full bg-white border-2 border-blue-500 text-blue-600 hover:bg-blue-50 hover:border-blue-600 font-bold py-4 rounded-xl transition-all shadow-md hover:shadow-lg active:scale-[0.98] transform">
                                Assign Shift
                            </button>
                        </div>
                    </div>
                ...
                <div className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-emerald-200">
                    ...
                    <div className="relative p-7">
                        ...
                        <div className="space-y-4">
                            <input value={rateChangeEmp} className="w-full bg-gray-50 border-2 border-gray-200 p-4 rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none transition-all font-mono text-sm placeholder:text-gray-400 hover:border-gray-300" placeholder="Employee Address (0x...)" onChange={e => setRateChangeEmp(e.target.value)} />
                            <div className="relative">
                                ...
                                <span className="absolute left-4 top-4 text-orange-600 font-bold text-lg">Ξ</span>
                            </div>
                            <button onClick={requestRateChange} className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40 active:scale-[0.98] transform">
                                Request Rate Change
                            </button>
                        </div>
                    </div>
                            ...
                            {myEmployees.map((emp, idx) => (
                                <div key={idx} className="group relative bg-gradient-to-br from-gray-50 to-gray-100 p-5 rounded-2xl border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300">
                                    ...
                                    <div className="relative">
                                        ...
                                        <button onClick={() => resetStrikes(emp)} className="flex items-center justify-center gap-2 w-full bg-white border-2 border-gray-200 text-gray-600 hover:text-orange-600 hover:border-orange-300 hover:bg-orange-50 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-sm hover:shadow-md">
