  ...
  return (
    <div className="bg-gray-800 p-3 rounded-xl border border-gray-700">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <h3 className="text-xs font-semibold text-gray-300 text-center">{monthName}</h3>
        <button
          onClick={nextMonth}
          className="p-0.5 hover:bg-gray-700 rounded transition-colors"
        >
      ...
      <div className="grid grid-cols-7 gap-0.5 mb-0.5">
        {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((day, idx) => (
          <div key={idx} className="text-center font-semibold text-gray-400 text-[10px] py-0.5">
            {day}
          </div>
        ))}
      </div>
          ...
          {calendarDays.map((day, index) => {
            ...
            return (
              <button
                ...
                className={`aspect-square p-0.5 rounded border font-medium text-[10px] transition-all cursor-pointer relative
